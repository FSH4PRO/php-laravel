        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge bg-info text-dark">{{ $product->stores->sum('pivot.quantity') }}</span></td>
                    <td><span class="badge bg-secondary">{{ $product->warehouses->sum('pivot.quantity') }}</span></td>
                    <td class="text-end">
                        <div class="btn-group">
